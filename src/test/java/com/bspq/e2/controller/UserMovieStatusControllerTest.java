...
class UserMovieStatusControllerTest {
    ...
    private MovieStatusDTO dto(long movieId, boolean watchLater, boolean watched, boolean liked, boolean disliked , String note, Integer rating) {
        return new MovieStatusDTO(movieId, watchLater, watched, liked, disliked, note, rating);
    }
    ...
    void saveForLater_returnsUpdatedStatus() throws Exception {
        when(statusService.saveForLater(1L, 10L)).thenReturn(dto(10L, true, false, false, false, null, null));
    ...
    void removeFromWatchLater_returnsUpdatedStatus() throws Exception {
        when(statusService.removeFromWatchLater(1L, 10L)).thenReturn(dto(10L, false, false, false, false, null, null));
    ...
    @Test
    void getWatchLaterList_returnsStatusList() throws Exception {
        when(statusService.getWatchLaterList(1L)).thenReturn(List.of(
                dto(10L, true, false, false, false, null, null),
                dto(11L, true, false, false, false, null, null)
        ));
    ...
    void markAsWatched_returnsUpdatedStatus() throws Exception {
        when(statusService.markAsWatched(1L, 10L)).thenReturn(dto(10L, false, true, false, false, null, null    ));
    ...
    void removeFromWatched_returnsUpdatedStatus() throws Exception {
        when(statusService.removeFromWatched(1L, 10L)).thenReturn(dto(10L, false, false, false, false, null, null    ));
    ...
    void likeMovie_returnsUpdatedStatus() throws Exception {
        when(statusService.likeMovie(1L, 10L)).thenReturn(dto(10L, false, true, true, false, null, null    ));
    ...
    void removeLike_returnsUpdatedStatus() throws Exception {
        when(statusService.removeLike(1L, 10L)).thenReturn(dto(10L, false, true, false, false, null, null    ));
    ...
    void dislikeMovie_returnsUpdatedStatus() throws Exception {
        when(statusService.dislikeMovie(1L, 10L)).thenReturn(dto(10L, false, true, false, true, null, null));
    ...
    void removeDislike_returnsUpdatedStatus() throws Exception {
        when(statusService.removeDislike(1L, 10L)).thenReturn(dto(10L, false, true, false, false, null, null));
    ...
    void getStatus_returnsCurrentStatus() throws Exception {
        when(statusService.getStatus(1L, 10L)).thenReturn(dto(10L, true, false, false, false, null, null));
    ...
    void updateNote_returnsUpdatedStatus() throws Exception {
        when(statusService.updateNote(1L, 10L, "Great movie"))
                .thenReturn(new MovieStatusDTO(10L, false, true, false, false, "Great movie",null));
    ...
    void clearNote_returnsUpdatedStatus() throws Exception {
        when(statusService.updateNote(1L, 10L, null))
                .thenReturn(new MovieStatusDTO(10L, false, true, false, false, null, null));
    ...
    void rateMovie_returnsUpdatedStatus() throws Exception {
        when(statusService.rateMovie(eq(1L), eq(10L), eq(4)))
                .thenReturn(new MovieStatusDTO(10L, false, true, false, false, null, 4));
